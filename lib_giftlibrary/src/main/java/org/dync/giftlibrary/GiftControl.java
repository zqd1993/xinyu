...
public class GiftControl implements GiftFrameLayout.LeftGiftAnimationStatusListener {
     ...
     * 礼物队列
     */
    private final ArrayList<GiftModel> mGiftQueue;
     ...
     */
    public void loadGift(final GiftModel gift, boolean supportCombo) {
        if (mGiftQueue != null) {
            if (supportCombo) {
    ...
    private GiftOnClickListener onClickListener;

    public interface GiftOnClickListener{
        void onHeadClick(int user_id);
    }

    public void setOnClickListener(GiftOnClickListener onClickListener){
    ...
    public synchronized void showGift() {
        ...
        final GiftFrameLayout giftFrameLayout;
...
//            giftFrameLayout.firstHideLayout();
            ...
            if (hasGift) {
                giftFrameLayout.findViewById(R.id.headIv)
                        .setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                if (onClickListener != null) {
                                    onClickListener.onHeadClick(Integer.parseInt(giftFrameLayout.getGift().getSendUserId()));
                                }
                            }
                        });
