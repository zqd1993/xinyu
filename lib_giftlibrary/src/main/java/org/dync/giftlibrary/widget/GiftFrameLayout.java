...
//    }
    ...
    private void initView() {
        rootView = mInflater.inflate(R.layout.item_gift_lib, null);
     ...
     * 因为余数为0的话，说明在这个时刻即执行了{@link GiftControl#(GiftFrameLayout, int)}移除动画{@link #endAnmation(ICustormAnim)},也执行了检查监听连击动作。
