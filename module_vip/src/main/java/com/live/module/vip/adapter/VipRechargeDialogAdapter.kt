 ...
 * description:
 */
class VipRechargeDialogAdapter :
    BaseQuickAdapter<VipRechargeBean, BaseViewHolder>(R.layout.vip_item_recharge_dialog) {
    var select: Int = -1
...
//    var optimalIndex = 1
    override fun convert(holder: BaseViewHolder, item: VipRechargeBean) {
        ...
        holder.setText(R.id.tv_month, item.vip_duration.toString())
