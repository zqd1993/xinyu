...
public class FaceBeautyDataFactory extends AbstractFaceBeautyDataFactory {
    ...
    public void reset() {
//        defaultFaceBeauty = FaceBeautySource.getDefaultFaceBeauty();
        FaceBeautySource.reset(defaultFaceBeauty);
        bindCurrentRenderer();
    }
    ...
    /*当前生效美颜数据模型*/
    public FaceBeauty defaultFaceBeauty = FaceBeautySource.getFaceBeauty();

    /*当前生效美颜数据模型*/
    public FaceBeauty faceBeauty = defaultFaceBeauty;
