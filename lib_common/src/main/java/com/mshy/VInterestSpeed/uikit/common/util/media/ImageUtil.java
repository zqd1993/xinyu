...
import com.mshy.VInterestSpeed.uikit.business.session.viewholder.MsgViewHolderThumbBase;
import com.mshy.VInterestSpeed.uikit.common.media.picker.util.BitmapUtil;
...
public class ImageUtil {
    ...
    public static Boolean scaleImage(File srcFile, File dstFile, int dstMaxWH, CompressFormat compressFormat, int quality) {
        ...
        try {
            ...
            float rotate;
            String mimeType = BitmapUtil.getImageType(srcFile.getAbsolutePath());
