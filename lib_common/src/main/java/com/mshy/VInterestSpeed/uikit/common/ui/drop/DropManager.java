package com.mshy.VInterestSpeed.uikit.common.ui.drop;
...
public class DropManager {
    ...
    static final int TEXT_SIZE = ScreenUtil.sp2px(10); // 12sp

    static final int CIRCLE_RADIUS = ScreenUtil.dip2px(7.0f); // 10dip
    ...
    public Paint getCirclePaint() {
        if (circlePaint == null) {
            ...
            circlePaint.setColor(Color.parseColor("#FFFF3B30"));
