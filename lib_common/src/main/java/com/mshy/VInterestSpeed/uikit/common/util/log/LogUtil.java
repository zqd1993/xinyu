package com.mshy.VInterestSpeed.uikit.common.util.log;


import com.mshy.VInterestSpeed.uikit.common.util.log.sdk.LogBase;
import com.mshy.VInterestSpeed.uikit.common.util.log.sdk.wrapper.NimLog;
import com.mshy.VInterestSpeed.uikit.common.util.storage.ExternalStorage;
...
public class LogUtil extends NimLog {
    ...
    public static void e(String msg) {
        getLog().e("error", buildMessage(msg));
    }
