package com.mshy.VInterestSpeed.uikit.business.session.viewholder.robot;
...
import com.mshy.VInterestSpeed.uikit.business.robot.model.RobotBotContent;
import com.mshy.VInterestSpeed.uikit.business.robot.model.RobotResponseContent;
import com.mshy.VInterestSpeed.uikit.business.robot.parser.elements.base.Element;
import com.mshy.VInterestSpeed.uikit.business.robot.parser.elements.element.ImageElement;
import com.mshy.VInterestSpeed.uikit.business.robot.parser.elements.element.TextElement;
import com.mshy.VInterestSpeed.uikit.business.robot.parser.elements.group.LinkElement;
import com.mshy.VInterestSpeed.uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.mshy.VInterestSpeed.uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.mshy.VInterestSpeed.uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
