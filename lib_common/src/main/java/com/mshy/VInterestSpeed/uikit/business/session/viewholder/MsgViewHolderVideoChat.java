...
import com.mshy.VInterestSpeed.uikit.attchment.MessageVquVideoAttachment;
...
public class MsgViewHolderVideoChat extends MsgViewHolderBase {
    ...
    private MessageVquVideoAttachment mVideoAttachment;

    public MsgViewHolderVideoChat(BaseMultiItemFetchLoadAdapter adapter) {
        super(adapter);
    }
    ...
    protected void bindHolder(BaseViewHolder holder) {
        mLl_left.setOnClickListener(view -> {
            if (getMsgAdapter().getEventListener() != null) {
                getMsgAdapter().getEventListener().onVideoClick();
            }
        });
    ...
    protected void bindContentView() {
        ...
        mVideoAttachment = (MessageVquVideoAttachment) message.getAttachment();
        switch (mVideoAttachment.getType()) {
            case 15:
                if(mVideoAttachment.getCalltype() == 0){
                    if (UserSpUtils.INSTANCE.getUserBean() != null
                        ...
                        if (mVideoAttachment.getFrom_uid().equals(UserSpUtils.INSTANCE.getUserBean().getUserId())) {  //发送的
                            ...
                            if (mVideoAttachment.getStatus() == 1) {
                                ...
                                mIvVideoRight.setImageResource(R.mipmap.resources_vqu_nim_ic_video_right_un);
                                ...
                                // mTv_right_video_message.setText("视频时长" + secondToTime(mVideoAttachment.getCall_time()));
                                mIvVideoRight.setImageResource(R.mipmap.resources_vqu_nim_ic_video_right);
                            } else {
                                mIvVideoRight.setImageResource(R.mipmap.resources_vqu_nim_ic_video_right);
                            }
                        } else {  //接收的
                            ...
                            if (mVideoAttachment.getStatus() == 1) {
                                ...
                                mIvVideoLeft.setImageResource(R.mipmap.resources_vqu_nim_ic_video_left_un);
                            } else if (mVideoAttachment.getStatus() == 2) {
                                ...
                                //  mTv_left_video_message.setText("通话时长:" + secondToTime(mVideoAttachment.getCall_time()));
                                mIvVideoLeft.setImageResource(R.mipmap.resources_tanta_nim_ic_video_left);
                            } else {
                                mIvVideoLeft.setImageResource(R.mipmap.resources_tanta_nim_ic_video_left);
                            }
                        }
