package com.mshy.VInterestSpeed.uikit.impl;
...
import com.mshy.VInterestSpeed.uikit.api.UIKitInitStateListener;
import com.mshy.VInterestSpeed.uikit.api.UIKitOptions;
import com.mshy.VInterestSpeed.uikit.api.model.chatroom.ChatRoomMemberChangedObservable;
import com.mshy.VInterestSpeed.uikit.api.model.chatroom.ChatRoomProvider;
import com.mshy.VInterestSpeed.uikit.api.model.chatroom.ChatRoomSessionCustomization;
import com.mshy.VInterestSpeed.uikit.api.model.contact.ContactChangedObservable;
import com.mshy.VInterestSpeed.uikit.api.model.contact.ContactEventListener;
import com.mshy.VInterestSpeed.uikit.api.model.contact.ContactProvider;
...
import com.mshy.VInterestSpeed.uikit.api.model.main.LoginSyncDataStatusObserver;
import com.mshy.VInterestSpeed.uikit.api.model.main.OnlineStateChangeObservable;
import com.mshy.VInterestSpeed.uikit.api.model.main.OnlineStateContentProvider;
import com.mshy.VInterestSpeed.uikit.api.model.recent.RecentCustomization;
import com.mshy.VInterestSpeed.uikit.api.model.robot.RobotInfoProvider;
...
import com.mshy.VInterestSpeed.uikit.api.model.superteam.SuperTeamChangedObservable;
import com.mshy.VInterestSpeed.uikit.api.model.superteam.SuperTeamProvider;
import com.mshy.VInterestSpeed.uikit.api.model.team.TeamChangedObservable;
import com.mshy.VInterestSpeed.uikit.api.model.team.TeamProvider;
import com.mshy.VInterestSpeed.uikit.api.model.user.IUserInfoProvider;
import com.mshy.VInterestSpeed.uikit.api.model.user.UserInfoObservable;
import com.mshy.VInterestSpeed.uikit.business.chatroom.fragment.ChatRoomMessageFragment;
import com.mshy.VInterestSpeed.uikit.business.chatroom.viewholder.ChatRoomMsgViewHolderBase;
import com.mshy.VInterestSpeed.uikit.business.chatroom.viewholder.ChatRoomMsgViewHolderFactory;
import com.mshy.VInterestSpeed.uikit.business.contact.selector.activity.ContactSelectActivity;
import com.mshy.VInterestSpeed.uikit.business.preference.UserPreferences;
import com.mshy.VInterestSpeed.uikit.business.session.activity.TeamMessageActivity;
...
import com.mshy.VInterestSpeed.uikit.business.session.emoji.StickerManager;
import com.mshy.VInterestSpeed.uikit.business.session.module.MsgForwardFilter;
...
import com.mshy.VInterestSpeed.uikit.business.session.viewholder.MsgViewHolderFactory;
import com.mshy.VInterestSpeed.uikit.business.team.activity.AdvancedTeamInfoActivity;
import com.mshy.VInterestSpeed.uikit.business.team.activity.NormalTeamInfoActivity;
import com.mshy.VInterestSpeed.uikit.support.glide.ImageLoaderKit;
import com.mshy.VInterestSpeed.uikit.common.util.log.LogUtil;
import com.mshy.VInterestSpeed.uikit.common.util.storage.StorageType;
import com.mshy.VInterestSpeed.uikit.common.util.storage.StorageUtil;
import com.mshy.VInterestSpeed.uikit.common.util.sys.ScreenUtil;
import com.mshy.VInterestSpeed.uikit.impl.cache.ChatRoomCacheManager;
import com.mshy.VInterestSpeed.uikit.impl.cache.DataCacheManager;
import com.mshy.VInterestSpeed.uikit.impl.customization.DefaultContactEventListener;
import com.mshy.VInterestSpeed.uikit.impl.customization.DefaultP2PSessionCustomization;
import com.mshy.VInterestSpeed.uikit.impl.customization.DefaultRecentCustomization;
import com.mshy.VInterestSpeed.uikit.impl.customization.DefaultTeamSessionCustomization;
import com.mshy.VInterestSpeed.uikit.impl.provider.DefaultChatRoomProvider;
import com.mshy.VInterestSpeed.uikit.impl.provider.DefaultContactProvider;
import com.mshy.VInterestSpeed.uikit.impl.provider.DefaultRobotProvider;
import com.mshy.VInterestSpeed.uikit.impl.provider.DefaultSuperTeamProvider;
import com.mshy.VInterestSpeed.uikit.impl.provider.DefaultTeamProvider;
import com.mshy.VInterestSpeed.uikit.impl.provider.DefaultUserInfoProvider;
...
public final class NimUIKitImpl {
    ...
    */
    ...
    public static void startP2PSessionFromInfo(Context context, String account) {
        startP2PSessionFromInfo(context, account, null);
    }

    public static void startP2PSession(Context context, String account, IMMessage anchor) {
        NimUIKitImpl.startChatting(context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, anchor);
    }
    public static void startP2PSessionFromInfo(Context context, String account, IMMessage anchor) {
        NimUIKitImpl.startChattingFromInfo(context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, anchor);
    }
    public static void startChattingFromInfo(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
            customization, IMMessage anchor) {
        if (sessionType == SessionTypeEnum.P2P) {
//            P2PMessageActivity.start(context, id, customization, anchor);
            ARouter.getInstance().build(RouteUrl.Message.MessageVquP2PAct)
                    .withString(Extras.EXTRA_ACCOUNT,id)
                    .withBoolean(RouteKey.FROM_INFO, true)
                    .withSerializable(Extras.EXTRA_CUSTOMIZATION,customization)
                    .withSerializable(Extras.EXTRA_ANCHOR,anchor)
                    .navigation();
