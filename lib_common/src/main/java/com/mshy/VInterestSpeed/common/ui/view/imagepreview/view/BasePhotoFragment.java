...
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.GPreviewVideoImgActivity;
            ...
            imageView.setOnViewTapListener(new PhotoViewAttacher.OnViewTapListener() {
                ...
                public void onViewTap(View view, float x, float y) {
                    if (imageView.checkMinScale()) {
                        ...
                        }else if(getActivity() instanceof GPreviewVideoImgActivity){
                            ((GPreviewVideoImgActivity) getActivity()).transformOut();
                        }
