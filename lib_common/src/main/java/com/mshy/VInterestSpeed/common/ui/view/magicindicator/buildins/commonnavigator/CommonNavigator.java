package com.mshy.VInterestSpeed.common.ui.view.magicindicator.buildins.commonnavigator;
...
import com.mshy.VInterestSpeed.common.ui.view.magicindicator.ScrollState;
...
import com.mshy.VInterestSpeed.common.ui.view.magicindicator.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private boolean mMiddle;//是否等分
    private boolean isWrapPagerIndicator;
    private float mSpacePx;//间距像素
    /****************************************************/

    // 保存每个title的位置信息，为扩展indicator提供保障
    private final List<PositionData> mPositionDataList = new ArrayList<PositionData>();
    ...
    public void setMiddle(boolean mMiddle) {
        this.mMiddle = mMiddle;
    }

    public void setIsWrapPagerIndicator(boolean isWrapPagerIndicator) {
        this.isWrapPagerIndicator = isWrapPagerIndicator;
    }

    public void setSpacePx(float mSpacePx) {
        this.mSpacePx = mSpacePx;
    }
        ...
        for (int i = 0, j = mNavigatorHelper.getTotalCount(); i < j; i++) {
            ...
            if (v instanceof View) {
                ...
                if (mAdjustMode) {
                    ...
                    if (mMiddle) {
                        if (isWrapPagerIndicator) {
                            lp.leftMargin = (int) mSpacePx;
                            if (i == j - 1) {
                                lp.rightMargin = (int) mSpacePx;
                            }
                        } else {
                            if (i == 0) {
                                lp.leftMargin = 0;
     ...
     * 添加红点的view
     */
    private View addRedPointView(View view) {
        LinearLayout layout = new LinearLayout(getContext());
        layout.setOrientation(LinearLayout.HORIZONTAL);
        layout.addView(view);
        View redPointView = new View(getContext());
