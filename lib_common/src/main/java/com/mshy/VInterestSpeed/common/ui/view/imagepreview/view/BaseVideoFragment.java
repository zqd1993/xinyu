...
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.GPVideoPlayerActivity;
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.GPreviewActivity;
...
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.loader.SimpleTarget;
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.loader.VideoClickListener;
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.photoview.PhotoViewAttacher;
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.wight.SmoothImageView;


/**
 * Created by liuzq on 2018/10/16.
 * Deprecated: 单个视频预览的fragment
 */
...
public class BaseVideoFragment extends Fragment {
    ...
    protected SimpleTarget<Bitmap> simpleTarget;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_gpvideoplayer, container, false);
    }

    public static BaseVideoFragment getInstance(Class<? extends BaseVideoFragment> fragmentClass,
                                                IThumbViewInfo item, boolean currentIndex,
                                                boolean isSingleFling,
                                                boolean isDrag,
                                                float sensitivity) {
        BaseVideoFragment fragment;
        try {
            fragment = fragmentClass.newInstance();
        } catch (Exception e) {
            fragment = new BaseVideoFragment();
        }
        Bundle bundle = new Bundle();
        bundle.putParcelable(BaseVideoFragment.KEY_PATH, item);
        bundle.putBoolean(BaseVideoFragment.KEY_TRANS_PHOTO, currentIndex);
        bundle.putBoolean(BaseVideoFragment.KEY_SING_FILING, isSingleFling);
        bundle.putBoolean(BaseVideoFragment.KEY_DRAG, isDrag);
        bundle.putFloat(BaseVideoFragment.KEY_SEN, sensitivity);
    ...
    private void initView(View view) {
        videoView=view.findViewById(R.id.gpVideo);
    ...
    private void initDate() {
        ...
        if (bundle != null) {
            ...
            if (beanViewInfo.getUrl().toLowerCase().contains(".gif")) {
                ...
                //加载图
                ZoomMediaLoader.getInstance().getLoader().displayGifImage(this, beanViewInfo.getUrl(), imageView, simpleTarget);
            } else {
                //加载图
                ZoomMediaLoader.getInstance().getLoader().displayImage(this, beanViewInfo.getUrl(), simpleTarget);
            }
