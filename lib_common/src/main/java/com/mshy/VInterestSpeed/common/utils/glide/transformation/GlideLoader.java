package com.mshy.VInterestSpeed.common.utils.glide.transformation;
...
import com.ellison.glide.translibrary.ImageUtils;import com.ellison.glide.translibrary.base.Loader;
...
public class GlideLoader implements Loader {
    ...
    private RequestOptions setTransformation(@NotNull LoaderBuilder loadConfig, RequestOptions requestOptions) {
        ...
        if (loadConfig.getRoundCornerRadii() != null) {
            ...
            if (loadConfig.getBorderWidth() > 0 && loadConfig.getRoundCornerRadius() > 0) {
                int[] co = new int[]{
                        (int) loadConfig.getRoundCornerRadius(),
                        (int) loadConfig.getRoundCornerRadius(),
                        (int) loadConfig.getRoundCornerRadius(),
                        (int) loadConfig.getRoundCornerRadius()
                };
