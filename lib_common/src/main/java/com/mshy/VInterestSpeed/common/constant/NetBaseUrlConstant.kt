...
//    const val AGREEMENT_URL = "/tianyuan/about/agreement_qy.html" //用户协议
//    const val RULE_URL = "/index/about/invite_help.html" //规则详情
//
//    const val USER_PRIVACY_URL = "/tianyuan/about/privacy_qy.html" //用户隐私协议
//
//    const val USER_permission_URL = "/tianyuan/about/permission_qy.html" //权限隐私
//
...
//    const val JUVENILE_PROTECTION = "/index/about/juvenile_protection_qy.html"    //未成年保护计划
    ...
    const val VIP_URL = "/index/about/vip_agreement_qy_op.html"
    const val CONTRACT_URL = "/index/about/service_op.html"
    const val HELP_URL_BOY = "/index/about/help_boy_op.html"
    const val HELP_URL_GIRL = "/index/about/help_girl_op.html"
    const val HELP_URL_SPECIAL = "/index/about/help_audit_op.html"
    const val AGREEMENT_URL = "/tianyuan/about/agreement_qy_op.html" //用户协议
    const val RULE_URL = "/index/about/invite_help_op.html" //规则详情

    const val USER_PRIVACY_URL = "/tianyuan/about/privacy_qy_op.html" //用户隐私协议

    const val USER_permission_URL = "/tianyuan/about/permission_qy_op.html" //权限隐私

    const val USER_thirdparty_sdk_URL = "/index/about/thirdparty_sdk_qy_op.html" //第三方sdk目录

    const val RECHARGE_AGREEMENT = "/index/about/recharge_agreement_qy_op.html"    //充值协议
    const val JUVENILE_PROTECTION = "/index/about/juvenile_protection_qy_op.html"    //未成年保护计划
