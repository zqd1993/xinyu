...
import com.mshy.VInterestSpeed.common.databinding.CommonVquDialogInputCountBinding
 ...
 * description:
 */
class InputCountDialog : BaseDialogFragment<CommonVquDialogInputCountBinding>(),
...
//        mBinding.tvCommonDialogMessageContent.postDelayed(
//            {
//                mBinding.tvCommonDialogMessageContent.isFocusable = true
//                mBinding.tvCommonDialogMessageContent.requestFocus()
//                AppManager.getInstance()
//                    .showSoftKeyBoard(requireActivity(), mBinding.tvCommonDialogMessageContent)
//            }, 500
//        )
     ...
     * 设置Dialog标题
     */
    fun setTitle(title: CharSequence): InputCountDialog {
        mTitle = title
        return this
    }
     ...
     * 设置Dialog标题
     */
    fun setTitle(@StringRes title: Int): InputCountDialog {
     ...
     * 设置Dialog内容
     */
    fun setContent(content: CharSequence): InputCountDialog {
        mContent = content
        return this
    }
     ...
     * 设置Dialog内容
     */
    fun setContent(@StringRes content: Int): InputCountDialog {
     ...
     * 设置Dialog内容
     */
    fun setContentMaxLength(maxLength: Int): InputCountDialog {
     ...
     * 设置Dialog输入框提示文案
     */
    fun setHint(hint: CharSequence): InputCountDialog {
        mHint = hint
        return this
    }
     ...
     * 设置Dialog输入框提示文案
     */
    fun setHint(@StringRes hint: Int): InputCountDialog {
     ...
     * 设置Dialog输入框提示文案颜色
     */
    fun setHintColor(@ColorInt color: Int): InputCountDialog {
        mHintColor = color
        return this
    }
     ...
     * 设置右边按钮文字
     */
    fun setRightText(rightText: CharSequence): InputCountDialog {
     ...
     * 设置右边按钮文字
     */
    fun setRightText(@StringRes rightText: Int): InputCountDialog {
     ...
     * 设置左边按钮文字
     */
    fun setLeftText(leftText: CharSequence): InputCountDialog {
        mLeftText = leftText
        return this
    }
     ...
     * 设置左边按钮文字
     */
    fun setLeftText(@StringRes leftText: Int): InputCountDialog {
     ...
     * 设置单个按钮的文字
     */
    fun setSingleText(@StringRes leftText: Int): InputCountDialog {
     ...
     * true Html文本
     */
    fun setIsHtml(isHtml: Boolean): InputCountDialog {
        mIsHtml = isHtml
        return this
    }
     ...
     * true 单个按钮
     */
    fun setIsSingleButton(isSingleButton: Boolean): InputCountDialog {
     ...
     * 设置是否可以关闭
     */
    fun setCancelAble(cancelAble: Boolean): InputCountDialog {
    ...
    override fun CommonVquDialogInputCountBinding.initView() {
