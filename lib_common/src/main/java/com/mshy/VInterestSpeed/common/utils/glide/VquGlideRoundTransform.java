package com.mshy.VInterestSpeed.common.utils.glide;
...
public class VquGlideRoundTransform extends CenterCrop {
     ...
     * @param radius
     */
    public VquGlideRoundTransform(Context context, int radius) {
     ...
     * @param borderWidth
     */
    public VquGlideRoundTransform(Context context, int radius, String borderColor, int borderWidth) {
        mRadius = Resources.getSystem().getDisplayMetrics().density * radius;
