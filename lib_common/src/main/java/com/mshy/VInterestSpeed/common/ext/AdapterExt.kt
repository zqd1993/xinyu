...
fun BaseQuickAdapter<*, *>.setNbOnItemClickListener(interval: Long = 1,action: (adapter: BaseQuickAdapter<*, *>, view: View, position: Int) -> Unit) {
...
fun BaseQuickAdapter<*, *>.setNbOnItemChildClickListener(interval: Long = 1,action: (adapter: BaseQuickAdapter<*, *>, view: View, position: Int) -> Unit) {
