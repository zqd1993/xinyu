package com.mshy.VInterestSpeed.common.websocket;
...
import com.mshy.VInterestSpeed.common.websocket.listener.WsStatusListener;
import com.live.vquonline.base.utils.GsonUtil;
import com.mshy.VInterestSpeed.common.bean.websocket.WebSocketRequestBean;
...
//      wsUrl = wsUrl.replace("ws.zhenban.top", "112.124.23.70:29000");
  ...
  public boolean sendObjectMessage(WebSocketRequestBean bean) {
    if(bean == null) return false;
    return send(GsonUtil.GsonString(bean)+"@@");
  }
