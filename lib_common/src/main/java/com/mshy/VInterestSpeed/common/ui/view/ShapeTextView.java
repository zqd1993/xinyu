...
//            gradientDrawable.setOrientation(GradientDrawable.Orientation.LEFT_RIGHT);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        openSelector = ta.getBoolean(R.styleable.ShapeTextView_stv_openSelector, false);
        startColor = ta.getInteger(R.styleable.ShapeTextView_stv_startColor, 0x00000000);
        endColor = ta.getInteger(R.styleable.ShapeTextView_stv_endColor, 0x00000000);
        solidColor = ta.getInteger(R.styleable.ShapeTextView_stv_solidColor, 0x00000000);
        strokeColor = ta.getInteger(R.styleable.ShapeTextView_stv_strokeColor, 0x00000000);

        solidTouchColor = ta.getInteger(R.styleable.ShapeTextView_stv_solidTouchColor, 0x00000000);
        strokeTouchColor = ta.getInteger(R.styleable.ShapeTextView_stv_strokeTouchColor, 0x00000000);
        //textTouchColor = ta.getInteger(R.styleable.ShapeTextView_textTouchColor, 0x00000000);
        textColor = getCurrentTextColor();
        strokeWidth = (int) ta.getDimension(R.styleable.ShapeTextView_stv_strokeWidth, 0);

        //四个角单独设置会覆盖radius设置
        radius = ta.getDimension(R.styleable.ShapeTextView_stv_layoutRadius, 0);
        topLeftRadius = ta.getDimension(R.styleable.ShapeTextView_stv_topLeftRadius, radius);
        topRightRadius = ta.getDimension(R.styleable.ShapeTextView_stv_topRightRadius, radius);
        bottomLeftRadius = ta.getDimension(R.styleable.ShapeTextView_stv_bottomLeftRadius, radius);
        bottomRightRadius = ta.getDimension(R.styleable.ShapeTextView_stv_bottomRightRadius, radius);

        dashGap = ta.getDimension(R.styleable.ShapeTextView_stv_dashGap, 0);
        dashWidth = ta.getDimension(R.styleable.ShapeTextView_stv_dashWidth, 0);
