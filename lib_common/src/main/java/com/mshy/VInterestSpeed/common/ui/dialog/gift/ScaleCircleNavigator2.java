...
public class ScaleCircleNavigator2 extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public ScaleCircleNavigator2(Context context) {
        super(context);
        init(context);
    }
