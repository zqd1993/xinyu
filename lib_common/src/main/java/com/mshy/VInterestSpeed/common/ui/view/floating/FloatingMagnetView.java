...
//        updateSize();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                x = event.getRawX();
                y = event.getRawY();
                Log.d("aaaa", "ACTION_DOWN x: " + x);
                Log.d("aaaa", "ACTION_DOWN y: " + y);
            ...
            case MotionEvent.ACTION_UP:
                clearPortraitY();
                float diffX = event.getRawX();
                float diffY = event.getRawY();
                float absX = Math.abs((diffX - x));
                float absY = Math.abs((diffY - y));
                Log.d("aaaa", "ACTION_UP x: " + x);
                Log.d("aaaa", "ACTION_UP y: " + y);
                Log.d("aaaa", "ACTION_UP diffX: " + diffX);
                Log.d("aaaa", "ACTION_UP diffY: " + diffY);
                Log.d("aaaa", "onTouchEvent absX: " + absX);
                Log.d("aaaa", "onTouchEvent absY: " + absY);
                moveToEdge();
                if ((absX < 5 && absY < 5)) {
                    if (isOnClickEvent()) {
    ...
    protected boolean isOnClickEvent() {
        if (System.currentTimeMillis() - mLastMoveTime < 500) {
            return false;
        }
