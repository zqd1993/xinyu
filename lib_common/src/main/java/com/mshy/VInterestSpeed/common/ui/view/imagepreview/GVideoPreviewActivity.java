...
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.view.BaseVideoFragment;
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.wight.BezierBannerView;
import com.mshy.VInterestSpeed.common.ui.view.imagepreview.wight.PhotoViewPager;
...
public class GVideoPreviewActivity extends FragmentActivity {
    private static final String TAG = GVideoPreviewActivity.class.getName();
    ...
    private void initData() {
        ...
        try {
            ...
            Class<? extends BaseVideoFragment> sss;
            sss = (Class<? extends BaseVideoFragment>) getIntent().getSerializableExtra("className");
            iniFragment(imgUrls, currentIndex, sss);
        } catch (Exception e) {
            iniFragment(imgUrls, currentIndex, BaseVideoFragment.class);
        }
     ...
     **/
    protected void iniFragment(List<IThumbViewInfo> imgUrls, int currentIndex, Class<? extends BaseVideoFragment> className) {
        if (imgUrls != null) {
            int size = imgUrls.size();
            for (int i = 0; i < size; i++) {
                fragments.add(BaseVideoFragment.
    ...
    private void initView() {
        ...
        viewPager.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                BaseVideoFragment fragment = fragments.get(currentIndex);
    ...
    public void transformOut() {
        ...
        if (currentItem < imgUrls.size()) {
            BaseVideoFragment fragment = fragments.get(currentItem);
            if (ltAddDot != null) {
                ltAddDot.setVisibility(View.GONE);
            } else {
                bezierBannerView.setVisibility(View.GONE);
    ...
    @Override
    public void finish() {
        BaseVideoFragment.listener = null;
        super.finish();
    }
     ...
     * @return List
     **/
    public List<BaseVideoFragment> getFragments() {
        return fragments;
    }
