...
import com.shuyu.gsyvideoplayer.utils.GSYVideoType.SCREEN_TYPE_DEFAULT
            ...
            gestureDetector = GestureDetector(
                ...
                object : GestureDetector.SimpleOnGestureListener() {
                    ...
                    override fun onSingleTapConfirmed(e: MotionEvent): Boolean {
                        var player = this@EmptyControlVideo.currentPlayer
                        if (player.currentState == CURRENT_STATE_PLAYING) {
                            player.onVideoPause()
                        } else {
