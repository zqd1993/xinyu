 ...
 */
@AndroidEntryPoint
@Route(path = RouteUrl.Contact.ContactTantaFriendValueActivity)
class ContactTantaFriendValueActivity :
    ...
    override fun setStatusBar() {
        ...
        ImmersionBar.with(this@ContactTantaFriendValueActivity)
